...
filename = "cornell_box_with_spher_and_new_PDF_functions.ppm"
...
def main():
    ...
    # Light Sources quad (no material)
    empty_material = None
    lights = Quad(Point3(343,554,332), Vec3(-130,0,0), Vec3(0,0,-105), empty_material)
